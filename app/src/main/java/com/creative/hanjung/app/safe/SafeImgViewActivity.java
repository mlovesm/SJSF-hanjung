...
import com.creative.hanjung.app.util.CustomBitmapPool;
...
public class SafeImgViewActivity extends AppCompatActivity {
    ...
    public void async_progress_dialog(String callback){
        ...
        url= MainActivity.ipAddress+ MainActivity.contextPath+"/rest/Safe/safeWriteTipImage/large_cd/"+large_cd+"/mid_cd/"+mid_cd+"/chk_cd/"+chk_cd;
