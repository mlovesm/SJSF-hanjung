...
public class SafeMainFragment extends Fragment {
    ...
    private static String UPLOAD_URL = MainActivity.ipAddress+ MainActivity.contextPath+"/Safe/fileUpload.do";
    private String url;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sabun_no = MainActivity.loginSabun;
...
//                            Fragment fm = getFragmentManager().findFragmentByTag("dfdf");
    ...
    public void goMenu2() {
        Fragment fragment = new SafeHistoryFragment();
        ...
        bundle.putString("url", MainActivity.ipAddress+ MainActivity.contextPath+"/Safe/safe_check_history.do?large_cd="+selectDaeClassKey+"&mid_cd="
                +selectJungClassKey+"&sabun_no="+ sabun_no+"&j_pos="+ MainActivity.jPos);
