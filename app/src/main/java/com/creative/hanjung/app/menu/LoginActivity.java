...
import com.creative.hanjung.app.retrofit.LoginDatas;
...
/*        Toast.makeText(getApplicationContext(), "sabun_no : " + sabun_no+",user_nm : " + user_nm+",user_sosok : "
            ...
            public void onResponse(Call<Datas> call, Response<Datas> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if(status.equals("true")){
                        ...
                        if(response.body().getList().get(0).get("driverYN").toString().equals("Y")){
                            driverYN= true;
                        }else{
                            driverYN= false;
                        }
    ...
    public void onLoginSuccess() {
        ...
        Intent intent;
        if(driverYN){
            intent = new Intent(getBaseContext(),TransitMainActivity.class);
